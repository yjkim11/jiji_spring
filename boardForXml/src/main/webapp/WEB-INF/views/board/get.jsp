...
<%@include file="../includes/header.jsp"%>
 ...
 <style>
	...
	/* replyService.update({rno:12, bno:bnoValue, reply:"12번을 수정한다!!!"}, function(result){
		alert("수정 완료");
	}); */
	...
	/* replyService.add({reply:"JS Test", replyer:"yoonja", bno:bnoValue},
